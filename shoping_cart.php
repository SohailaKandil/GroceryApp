            ...
            <tbody>
                ...
                <?php
                    while ($row_cart = $result_view_cart->fetch_assoc()) {
                        ...
                        $product_discount = $row_cart["amount"] *100 . "%";
                        ...
                        echo "<tr>";
                            ...
                            echo "<td><a class='btn btn-success checkout-btn' href='buy_form.php?id=$product_id'>Buy</a></td>";
                            echo "<td><a class='btn btn-success checkout-btn' href='product_details.php?id=$product_id'>View</a></td>";
                            echo "<td><a class='btn btn-success checkout-btn' href='delete_from_cart.php?id=$product_id'>Remove</a></td>";
                        echo"</tr>";
                    }        
                ?>
            </tbody>

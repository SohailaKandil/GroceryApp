...
<?php
  ...
  $sql = "SELECT p.product_name , p.product_id , p.price , p.discount , p.exp_date , b.brand_name , s.shareholder_name , s.nationality
...
<html lang="en">
  ...
  <body>
    <div class="container my-5">
        ...
        <a type="button" class="btn btn-primary" href="add_product_page.php">Add product</a> 
        <br>
        <table class="table">
          <thead>
              <tr>
                  ...
                  <th scope="col">shareholder nationality</th>
            ...
            <?php
              ...
              while ($row = $result -> fetch_assoc()){
                ...
                <tr>
                  ...
                  <td>
                      <a type='button' class='btn btn-primary' href='edit_product.php?id={$row['product_id']}'>Edit</a>
                      <a type='button' class='btn btn-primary' href='delete_product.php?id={$row['product_id']}'>Delete</a>
                  </td>
                </tr>
                ");
